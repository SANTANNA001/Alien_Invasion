...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        ## Start a new gam when the player click 'Play'
    ...
    def _create_fleet(self):
        ...
        available_space_x = self.settings.screen_height - (1 * alien_width)
    ...
    def _update_aliens(self):
        ## Check if the fleet is at the edge, then Update positions of all aliens in the fleet
    ...
    def _update_bullets(self):
        ...
        self.bullets.update()
         ...
         #Get rid of bullets that dissappeared 
    ...
    def _check_bullet_alien_collisions(self):
        ...
        #Check for any bullets that have hit and alien
